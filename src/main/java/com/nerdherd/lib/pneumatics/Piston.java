...
public class Piston extends SubsystemBase {
  ...
  public Piston(int port1, int port2) {
    m_piston = new DoubleSolenoid(PneumaticsModuleType.CTREPCM, port1, port2);
  }

  public Piston(PneumaticsModuleType module, int port1, int port2) {
    m_piston = new DoubleSolenoid(module, port1, port2);
  }
